...
extern "C" IL2CPP_METHOD_ATTR void CanvasRenderer_SetAlpha_m54E7C6AEA9CD4D5C34F729B10B29F3B1146FB2BD (CanvasRenderer_tB4D9C9FE77FD5C9C4546FC022D6E956960BC2B72 * __this, float ___alpha0, const RuntimeMethod* method)
{
	Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  V_0;
	memset(&V_0, 0, sizeof(V_0));
	{
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_0 = CanvasRenderer_GetColor_m841EC074805A87FBD6D3EF7A17BEA2476AEBA31D(__this, /*hidden argument*/NULL);
		V_0 = L_0;
		float L_1 = ___alpha0;
		(&V_0)->set_a_3(L_1);
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_2 = V_0;
		CanvasRenderer_SetColor_mD19F4B2314FD9820902AF6ED1F0392FC78447C06(__this, L_2, /*hidden argument*/NULL);
		return;
	}
}
